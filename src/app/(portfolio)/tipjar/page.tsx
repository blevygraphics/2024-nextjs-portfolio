...
export default function Tipjar() {
	...
	return (
		<PageLayout animations={variants} bgColor='bg-yellow-400 absolute'>
			...
			<Image src="/tipjar/tipjar-1.png" className="lg:max-w-7xl" width={1400} height={1400} alt="tipjar 1" />
			<Image src="/tipjar/tipjar-2.png" className="lg:max-w-7xl" width={1400} height={1400} alt="tipjar 2" />
		</PageLayout>
	)
}
