...
export default function Print() {
	...
	return (
		<PageLayout animations={variants} bgColor='bg-red-600 absolute'>
			...
			<Image src="/print/print-1.jpg" className="lg:max-w-7xl" width={1400} height={1400} alt="Breaking Bad Poster" />
			<Image src="/print/print-2.jpg" className="lg:max-w-7xl" width={1400} height={1400} alt="The King's Music Poster" />
			<Image src="/print/print-3.jpg" className="lg:max-w-7xl" width={1400} height={1400} alt="Animals As Leaders Poster" />
			<Image src="/print/lt-vip-pass.jpg" className="lg:max-w-7xl" width={1400} height={1400} alt="LT VIP Pass" />
		</PageLayout>
	)
}
